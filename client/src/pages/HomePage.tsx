...
const HomePage = () => {
  const videoContent = [
    ...
    { video: video2, title: "Wonderfull", description: "Pack your bags and head out into the world, eager to explore new places and meet new faces. Each trip is a chance to make unforgettable memories, discover hidden gems, and enjoy life's simple pleasures." },
  ...
  return (
    <section className="home">
      <video
        className={`video-slider ${!loading ? "loaded" : ""}`}
